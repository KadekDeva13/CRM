  ...
  return (
    <div className="text-white">
      ...
      <form onSubmit={onSubmit} className="space-y-6 max-w-sm">
        ...
        <Field label={<span className="text-white/60 text-[17px] font-helectiva">Password</span>} htmlFor="password">
          <div className="relative ">
            <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-teal-300/70">
              <svg width="20" height="24" viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 20.4751C5.66665 19.8918 3.75 18.5376 2.25 16.4126C0.75 14.2876 0 11.9584 0 9.42512V3.4751L8 0.475098L16 3.4751V9.42512C16 11.9584 15.25 14.2876 13.75 16.4126C12.25 18.5376 10.3334 19.8918 8 20.4751ZM5 14.5001H11V9.50012H10V8.50012C10 7.95012 9.80415 7.47927 9.4125 7.08762C9.02085 6.69592 8.55 6.50012 8 6.50012C7.45 6.50012 6.97915 6.69592 6.5875 7.08762C6.19585 7.47927 6 7.95012 6 8.50012V9.50012H5V14.5001ZM6.75 9.50012V8.50012C6.75 8.16677 6.875 7.88762 7.125 7.66262C7.375 7.43762 7.66665 7.32512 8 7.32512C8.33335 7.32512 8.625 7.43767 8.875 7.66287C9.125 7.88817 9.25 8.16727 9.25 8.50012V9.50012H6.75Z" fill="#0F5A62" />
              </svg>
            </span>
            <input
              id="password"
