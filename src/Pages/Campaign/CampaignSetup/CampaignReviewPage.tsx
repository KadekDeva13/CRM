...
export default function CampaignReviewPage() {
  ...
  const segments: Segment[] = [
    { id: "premium", name: "Premium Customers", desc: "High-value customers with purchase history > $500", count: 2847 },
    { id: "vip", name: "VIP Members", desc: "Loyalty program members with tier status", count: 892 },
    { id: "new1", name: "New Subscribers", desc: "Recently subscribed users in the last 30 days", count: 1234 },
    { id: "new2", name: "New Subscribers", desc: "Recently subscribed users in the last 30 days", count: 1234 },
    { id: "new3", name: "New Subscribers", desc: "Recently subscribed users in the last 30 days", count: 1234 },
    { id: "inactive1", name: "Inactive Users", desc: "Users with no activity in the last 90 days", count: 5621 },
    { id: "inactive2", name: "Inactive Users", desc: "Users with no activity in the last 90 days", count: 5621 },
    { id: "inactive3", name: "Inactive Users", desc: "Users with no activity in the last 90 days", count: 5621 },
  ];
    ...
    navigate("/campaign/schedule", {
      state: {
        ...
        rules: {
          ...
          skipSpam,
          skipPurchased7,
          skipReceivedRecently,
          createLiveSuppression,
          suppressionInterval,
        },
      },
    });
  ...
  return (
    <div className="mx-auto max-w-[1100px] px-2 py-2 md:px-6 md:py-6">
      <div className="mb-3">
        ...
        <p className="text-[13px] text-zinc-500">Configure your email marketing campaign with smart automation features</p>
      </div>
          ...
          <div className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm">
            ...
            <div className="space-y-2 text-[13px] text-zinc-700">
              ...
              <label className="flex items-center gap-2">
                <input
                  type="checkbox"
                  checked={skipReceivedRecently}
                  onChange={(e) => setSkipReceivedRecently(e.target.checked)}
                />
            ...
            <div className="mt-4 space-y-3">
              <label className="flex items-center gap-2 text-[13px]">
                <input
                  type="checkbox"
                  checked={createLiveSuppression}
                  onChange={(e) => setCreateLiveSuppression(e.target.checked)}
                />
