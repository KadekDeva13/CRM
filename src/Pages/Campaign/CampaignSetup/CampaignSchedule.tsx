...
type LocationState = { template?: TemplateLite };
...
const radioActive = "border-emerald-500 bg-emerald-50";
...
export default function CampaignSchedulePage(): React.ReactElement {
  ...
  const onSave = async () => {
    ...
    setSaving(true);
    try {
      // --- Contoh payload (kalau perlu sambungkan ke API)
      // const payload =
      //   mode === "immediate"
      //     ? { mode }
      //     : mode === "fixed"
      //     ? { mode, fixedAt: new Date(fixedAt).toISOString() }
      //     : { mode, relativeDay, relativeTime };
      // await api.campaign.schedule(payload);

      // Tampilkan modal sukses, jangan navigate dulu
      setShowSuccess(true);
    } catch (e: any) {
  ...
  const RadioRow = ({
    ...
    return (
      <label
        className={[radioBase, active ? radioActive : radioInactive, "w-full"].join(" ")}
      >
        <input
          type="radio"
          name="schedule-mode"
      ...
      <div className="mx-auto max-w-[1100px] px-6 py-6">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm">
          <div className="border-b border-zinc-100 p-6">
            <h1 className="text-xl font-semibold text-zinc-900">Schedule Your Campaign</h1>
          ...
          <div className="space-y-3 p-6">
            ...
            <RadioRow value="immediate" title="Immediate" desc="Send the campaign right away" />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full appearance-none rounded-lg border border-zinc-300 bg-white px-3 py-2 pr-9 text-sm text-zinc-800 outline-none focus:ring-2 focus:ring-zinc-300"
                      >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-lg border border-zinc-300 bg-white px-10 py-2 text-sm text-zinc-800 outline-none focus:ring-2 focus:ring-zinc-300"
                      />
          ...
          <div className="flex items-center justify-between gap-3 border-t border-zinc-100 p-4">
            ...
            <button
              onClick={onSave}
              disabled={saving}
              className="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-emerald-700 active:scale-[.99] disabled:opacity-60"
            >
