...
export default function AppSidebar({
  ...
  const GROUPS: MenuGroup[] = [
    ...
    },
    {
      ...
      label: "Segments",
      icon: <IconProperty />,
      to: "/segments/all-segments",
      children: [
        { label: "All Segments", to: "/segments/all-segments" },
        { label: "Loyality Plans", to: "/properties/loyality-plans" },
      ],
    },
    {
      key: "guest",
  ...
  useEffect(() => {
    ...
    setOpenKeys(found ? new Set([found.key]) : new Set());
  }, [pathname]);
      ...
      >
        <div className="pt-16 h-full flex flex-col">
          <NavLink
            to="/overview"
            onClick={onCloseMobile}
            className="flex items-center justify-center gap-3 font-helectiva mb-5 px-3"
            aria-label="Go to Overview"
          >
            <img
              src="/image/Guirez.png"
              alt="guirez"
              className={collapsed ? "h-10 w-auto" : "h-10 w-auto"}
              draggable={false}
            />
            {!collapsed && (
              <Fragment>
                <span className="text-white/50 text-lg leading-none text-[25px]">|</span>
                <span className="tracking-[0.18em] text-[25px]">CRM</span>
              </Fragment>
            )}
          </NavLink>
              ...
              {!collapsed && (
                <>
                  <div className="flex-1">
                    <div className="text-white text-sm font-medium">MindiMedia</div>
                  ...
                  >
                    <svg width="14" height="15" viewBox="0 0 14 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M13.5597 5.30547C13.6472 5.54336 13.5734 5.80859 13.3847 5.97813L12.2007 7.05547C12.2308 7.28242 12.2472 7.51484 12.2472 7.75C12.2472 7.98516 12.2308 8.21758 12.2007 8.44453L13.3847 9.52187C13.5734 9.69141 13.6472 9.95664 13.5597 10.1945C13.4394 10.5199 13.2945 10.8316 13.1277 11.1324L12.9992 11.3539C12.8187 11.6547 12.6164 11.9391 12.3949 12.207C12.2336 12.4039 11.9656 12.4695 11.725 12.393L10.2019 11.909C9.83551 12.1906 9.43082 12.4258 8.99879 12.6035L8.65699 14.1648C8.6023 14.4137 8.4109 14.6105 8.15933 14.6516C7.78199 14.7145 7.39371 14.7473 6.99722 14.7473C6.60074 14.7473 6.21246 14.7145 5.83511 14.6516C5.58355 14.6105 5.39215 14.4137 5.33746 14.1648L4.99566 12.6035C4.56363 12.4258 4.15894 12.1906 3.79254 11.909L2.27222 12.3957C2.0316 12.4723 1.76363 12.4039 1.6023 12.2098C1.38082 11.9418 1.17847 11.6574 0.998005 11.3566L0.869489 11.1352C0.702693 10.8344 0.557771 10.5227 0.437458 10.1973C0.349958 9.95938 0.423786 9.69414 0.612458 9.52461L1.79644 8.44727C1.76636 8.21758 1.74996 7.98516 1.74996 7.75C1.74996 7.51484 1.76636 7.28242 1.79644 7.05547L0.612458 5.97813C0.423786 5.80859 0.349958 5.54336 0.437458 5.30547C0.557771 4.98008 0.702693 4.66836 0.869489 4.36758L0.998005 4.14609C1.17847 3.84531 1.38082 3.56094 1.6023 3.29297C1.76363 3.09609 2.0316 3.03047 2.27222 3.10703L3.79527 3.59102C4.16168 3.30938 4.56636 3.07422 4.9984 2.89648L5.34019 1.33516C5.39488 1.08633 5.58629 0.889453 5.83785 0.848437C6.21519 0.782812 6.60347 0.75 6.99996 0.75C7.39644 0.75 7.78472 0.782813 8.16207 0.845703C8.41363 0.886719 8.60504 1.08359 8.65972 1.33242L9.00152 2.89375C9.43355 3.07148 9.83824 3.30664 10.2046 3.58828L11.7277 3.1043C11.9683 3.02773 12.2363 3.09609 12.3976 3.29023C12.6191 3.5582 12.8214 3.84258 13.0019 4.14336L13.1304 4.36484C13.2972 4.66562 13.4421 4.97734 13.5625 5.30273L13.5597 5.30547ZM6.99996 9.9375C7.58012 9.9375 8.13652 9.70703 8.54675 9.2968C8.95699 8.88656 9.18746 8.33016 9.18746 7.75C9.18746 7.16984 8.95699 6.61344 8.54675 6.2032C8.13652 5.79297 7.58012 5.5625 6.99996 5.5625C6.4198 5.5625 5.8634 5.79297 5.45316 6.2032C5.04293 6.61344 4.81246 7.16984 4.81246 7.75C4.81246 8.33016 5.04293 8.88656 5.45316 9.2968C5.8634 9.70703 6.4198 9.9375 6.99996 9.9375Z" />
                    </svg>
                  </button>
                </>
              )}
...
function NavGroup({
  ...
  const Chevron = (
    <svg
      className={["h-3 w-3 transition-transform", isOpen ? "rotate-90 text-white" : "rotate-0 text-white/60"].join(" ")}
      viewBox="0 0 20 20"
      fill="currentColor"
    >
      ...
      <div className={groupRowClass}>
        {!collapsed && (
          hasChildren ? (
            <button
              ...
              className="shrink-0 p-1 rounded hover:bg-white/10 w-6 h-6 grid place-items-center"
        ...
        {group.to ? (
          <NavLink
            ...
            onClick={onAnyClick}
            className={({ isActive }) =>
              ["flex items-center", collapsed ? "justify-center" : "gap-2 flex-1", isActive ? "text-white" : ""].join(" ")
            }
          >
            <span className={collapsed ? "inline-flex" : "inline-flex mr-1"}>{group.icon}</span>
...
function IconCampaign() {
  return (
    <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M16.3334 4.9967C17.2006 6.81061 17.3653 8.88148 16.7955 10.8096C16.2257 12.7378 14.9619 14.3866 13.248 15.4377C11.5341 16.4889 9.49153 16.8679 7.51459 16.5016C5.53765 16.1354 3.76645 15.0498 2.54283 13.4544C1.31921 11.859 0.729922 9.86697 0.888692 7.86266C1.04746 5.85835 1.94304 3.9839 3.40257 2.60107C4.8621 1.21825 6.78213 0.425071 8.79208 0.374632C10.802 0.324194 12.7594 1.02007 14.2865 2.32795L16.0576 0.556073C16.1749 0.438797 16