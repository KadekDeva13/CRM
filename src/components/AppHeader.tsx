      ...
      <div className="grid h-full grid-cols-[auto_1fr_auto] items-center gap-3 px-3 md:px-4 md:[padding-left:calc(var(--left)+16px)]">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <button
            ...
            className="
              hidden md:inline-flex h-9 w-9 items-center justify-center rounded-md
              border border-black/10 dark:border-white/10
              text-black/80 dark:text-white
              hover:bg-black/5 dark:hover:bg-white/5
            "
          ...
          <form className="relative w-full max-w-[320px]">
            ...
            <input
              ...
              className="
                ...
                bg-white border-black/10 text-black placeholder-black/40
                focus:ring-1 focus:ring-black/10
                dark:bg-[#222429] dark:border-white/10 dark:text-white dark:placeholder-white/40
                dark:focus:ring-white/15
              "
            />
            <div className="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2">
              <div className="flex items-center rounded-md border px-2 py-0.5 text-[10px] bg-black/5 text-black/60 border-black/10 dark:bg-[#1e2024] dark:text-white/60 dark:border-white/10">/</div>
            </div>
          </form>
        </div>

        <div className="ml-auto flex items-center gap-2 text-black/80 dark:text-white/80">
          <button
            type="button"
            onClick={toggle}
          ...
          >
            <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M11 10.5H1c.48-.828 1-2.745 1-5a4 4 0 1 1 8 0c0 2.208.516 3.898.863 4.496.17.285.17.648-.001.933a1 1 0 0 1-.862.571Z" stroke="white" strokeOpacity=".95" />
              <path d="M4.586 11.5a2 2 0 0 0 3.828 0H4.586Z" fill="white" fillOpacity=".9" />
            </svg>
          </button>
        </div>
      </div>
